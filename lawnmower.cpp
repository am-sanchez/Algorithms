...
Project Information:
  ...
  File Name: Lawnmower.cpp
  Due Date: 9/22/2015
  Purpose: Alternating disks problem, lawnmower algorithm
...
README:
  Compiler: g++
  Navigate to project folder containing Lawnmower.cpp
  Open a terminal and run both of these commands

    g++ Lawnmower.cpp -o Lawnmower.out
    ./Lawnmower.out
*/                                                                                                                                                                      
...
int main()
{
 ...
 for (i = 0; i < 2*n; i++ )                                  // Loop to push light one before darks ones
  { 
	  // Go right   
	for (j = i; j< n * 2 - i; j++)
	{
	...
	i++; //increment outer loop counter again
  }                                                         
  // Algorithm finished
